...
(function ($) {
    function TouchCarousel(element, options) {
        ...
        this._itemsWrapper.bind(this._downEvent, function (e) {
            self._onDragStart(e);
        });
    ...
    TouchCarousel.prototype = {
        ...
        updateItemSize: function () {
            ...
            itemsJQ.each(function (index) {
                var jqItem = $(this);
                var itemObj = self.items[index];
                itemObj.width = (jqItem.outerWidth(true) || self.settings.itemFallbackWidth);
                itemObj.posX = currPosX;
                currPosX += itemObj.width;
            });
            this._totalItemsWidth = currPosX;
            this._dragContainer.css({
                width: currPosX
            });
        },
        ...
        _onDragStart: function (e) {
            if (!this._isDragging) {
                ...
                $(document).bind(this._moveEvent, function (e) {
                    self._onDragMove(e);
                });
                $(document).bind(this._upEvent, function (e) {
